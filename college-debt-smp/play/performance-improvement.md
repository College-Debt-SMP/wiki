...
Starting with Minecraft 26.2, the game now support Vulkan, which is a newer graphics API that can gain more performance advantages on modern hardware. If you do have a newer GPU or play on an Apple Silicon Mac, set the graphics mode to "Prefer Vulkan" in the Video Options.
