...
* Through the secure Tailscale network: `smp.sheldonbois.ts`

In case of , the public address will be temporarily shut off. The Tailscale network address is only accessible when your system is connected to the VPN.
...
Prism Launcher user can directly download the mod onto an existing instance with the Fabric Loader. The mod is not directly compatible with the Fabulously Optimized Modpack.

In any case where the mod is not updated to the latest version of Minecraft, use the Fabulously Optimized modpack in the meantime.
